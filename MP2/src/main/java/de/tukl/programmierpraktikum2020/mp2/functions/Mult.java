...
public class Mult implements Function {
    ...
    public String toString() {
        if (f1 instanceof Const) {
            if (((Const) f1).number == 1.0) {
                return f2.toString();
            } else if (((Const) f1).number == -1.0) {
                return '-'+f2.toString();
            } else if (f2 instanceof Const) {
                return (new Const(((Const) f1).number * ((Const) f2).number)).toString();
            }
        } else if (f2 instanceof Const) {
            if (((Const) f2).number == 1.0) {
                return f1.toString();
            } else if (((Const) f2).number == -1.0) {
                return '-'+f1.toString();
            }
        }
